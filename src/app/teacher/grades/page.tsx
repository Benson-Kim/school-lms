...
export default function GradesPage() {
	...
	const {
		...
		refetch,
		deleteGrades,
	} = useGrades({ page, pageSize, searchTerm });
	...
	const handleBulkDelete = async () => {
		...
		try {
			...
			toast.success(`Successfully deleted ${selectedGrades.length} grades`);
			setSelectedGrades([]);
			refetch();
		} catch (error) {
	...
	const exportToCSV = () => {
		toast.info("Exporting grades data...");
			...
			<div className="container mx-auto px-4 py-8">
				...
				<div className="flex justify-between items-center mb-6">
					...
					<div className="flex gap-2">
						<Button
							onClick={() => router.push("/teacher/grades/create")}
							icon={<FiPlus />}
						>
							Add Grade
						</Button>
