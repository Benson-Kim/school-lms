...
export default function ITSecurity() {
	...
	useEffect(() => {
		if (status === "unauthenticated") {
			showToast({
				title: "Success",
				description: "Please sign in as IT to manage security.",
				variant: "error",
			});
	...
	return (
		<div className="container mx-auto p-4">
			...
			<Card title="Security Overview" className="p-4">
				<p>Manage system security settings, user permissions, and logs.</p>
				<Button
					onClick={() => router.push("/it/security/logs")}
